...
static const char col_cyan3[]   = "#004C4C";

/* scheme */
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_cyan2, col_cyan2 },
	[SchemeSel]  = { col_gray4, col_pink3, col_pink3 },
};
...
static const Key keys[] = {
	...
	/* arrow movement for my workman layout XD */
